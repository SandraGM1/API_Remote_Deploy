...
#si el servidor cae, no persistiría el modelo... pero bueno
...
if __name__ == '__main__': #esto es un control, activa el modo de depuracio en modo local. Cuando esté en el servidor este bucle no se ejecuta con debug
    app.run(debug=True)
